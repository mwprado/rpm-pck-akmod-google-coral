...
# Do not ship or use DKMS metadata in the akmod package.
rm -f src/dkms.conf
...
- Add akmod-only packaging for Coral EdgeTPU gasket/apex modules
- Remove DKMS packaging path
